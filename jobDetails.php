            ...
            <div class="container glassmorphism">
              <div class="banner-headline-text-part">
                <div class="profile-container">
                  <img src="/CareerConnectDB/assets/images/<?php echo $row1['profile_pic'] ?>" alt="">
                </div>
              ...
              <div class="apply-save-box">
                ...
                if (isset($_SESSION['role_id']) && $_SESSION['role_id'] == 1 && isset($_SESSION['user_id'])) :  ?>
                  ...
                  ?>
                    ...
                    if ($now > $deadline) :
                    ?>
                      <a href="#" class="btn btn-outline">Expired<i class="utf-verified-badge"></i></a>
                    <?php else : ?>
                      <a href="./process/applyJob.php?key=<?php echo md5($job_id) . '&id=' . $job_id . '&cid=' . $company_id ?>" class="btn btn-primary">Apply Job<i class="utf-verified-badge"></i></a>
                    <?php endif; ?>
                  <?php
                  endif; ?>
                  <?php
                  ...
                  if ($saved->num_rows > 0) :
                  ?>
                    <a href="#" class="btn btn-outline">Saved<i class="utf-verified-badge"></i></a>
                  <?php else : ?>
                    <a href="./process/saveJob.php?key=<?php echo md5($job_id)  . "&id=" . $job_id  ?>" class="btn btn-outline">Save Job<i class="utf-verified-badge"></i></a>
                <?php endif;
                endif; ?>
              </div>
            </div>
