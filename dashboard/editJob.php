            ...
            <div class="input-group item-b">
              ...
              <div class="select-container">
                <select id="select-category" name="industry">
                  ...
                  ?>
                    <option value="<?php echo $jobCategory['id'] ?>" <?php if($jobCategory['id'] == $row['industry_id']) echo 'selected'; ?>><?php echo $jobCategory['name'] ?></option>
                  <?php } ?>
                </select>
            ...
            <div class="input-group  item-c">
              ...
              <div class="select-container">
                <select id="select-category" name="job_type">
                  ...
                  ?>
                    <option value="<?php echo $jobType['id'] ?>" <?php if($jobType['id'] == $row['job_status']) echo 'selected'; ?>><?php echo $jobType['type'] ?></option>
                  <?php } ?>
                </select>
                <span class="custom-arrow"></span>
              </div>
            ...
            <div class="input-group  item-e">
              ...
              <div class="select-container">
                <select id="select-category" name="edu_qualification">
                  ...
                  ?>
                    <option value="<?php echo $education['id'] ?>" <?php if($education['id'] == $row['edu_qualification']) echo 'selected'; ?>><?php echo $education['name'] ?></option>
                  <?php } ?>
                </select>
                <span class="custom-arrow"></span>
              </div>
            ...
            <div class="input-group  item-f">
              ...
              <div class="select-container">
                <select id="select-category" name="division_or_state" required>
                  ...
                  ?>
                    <option value="<?php echo $divisionOrState['id'] ?>" <?php if($divisionOrState['id'] == $row['state_id']) echo 'selected'; ?>><?php echo $divisionOrState['name'] ?></option>
                  <?php } ?>
                </select>
                <span class="custom-arrow"></span>
              </div>
            ...
            <div class="input-group  item-g">
              ...
              <div class="select-container">
                <select id="select-category" name="district_or_city">
                  ...
                  ?>
                    <option value="<?php echo $districtOrCity['id'] ?>" <?php if($districtOrCity['id'] == $row['city_id']) echo 'selected'; ?>><?php echo $districtOrCity['name'] ?></option>
                  <?php } ?>
                </select>
                <span class="custom-arrow"></span>
              </div>
